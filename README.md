...
`El ejemplo más simple de esta construcción es el programa *Suma.psc* 
de la Ayuda de PSeInt, un pequeño algoritmo que *pide al usuario dos números* para *sumarlos* 
y, después, *muestra el resultado* de la operación, 
al cual se le han hecho alguna adecuaciones para señalar 
las partes del algoritmo y el nombre de las variables en minúsculas:`
...
<img src="https://github.com/m0ii6s/README/blob/main/Imagenes/Tarea%201.1%20-%201.2.jpg" width="60%"/>
